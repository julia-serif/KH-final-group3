                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                ...
                                <ul>
                                    ...
                                    <li><a href="<%= request.getContextPath() %>/admin_Music.do">음원 관리</a> <!-- 음원 관리 -->
					<ul class="dropdown">
                                         <li><a href="<%= request.getContextPath() %>/admin_Music.do">음원</a></li>
                                         <li><a href="<%= request.getContextPath() %>/admin_artist.do">아티스트</a></li>
                                       </ul>
					</li>
                                    <li><a href="<%= request.getContextPath() %>/member.do">회원 관리</a></li> <!-- 사용자 관리 -->
                                    <li><a href="<%= request.getContextPath() %>/notice_list.do">고객센터 관리</a> <!-- 고객센터 관리 -->
                                        <ul class="dropdown">
