            ...
            <div class="classy-nav-container breakpoint-off">
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between" id="oneMusicNav">
                        ...
                        <!-- Nav brand -->
                        <a href="<%= request.getContextPath() %>/resources/index.html" class="nav-brand"><img src="../resources/img/core-img/logo.png" alt=""></a>
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul>
                                    <li><a href="<%= request.getContextPath() %>/resources/index.html">Home</a></li>
                                    <li><a href="<%= request.getContextPath() %>/resources/albums-store.html">Albums</a></li>
                                    <li><a href="#">Pages</a>
                                        <ul class="dropdown">
                                            <li><a href="<%= request.getContextPath() %>/resources/index.html">Home</a></li>
                                            <li><a href="<%= request.getContextPath() %>/resources/albums-store.html">Albums</a></li>
                                            <li><a href="<%= request.getContextPath() %>/resources/event.html">Events</a></li>
                                            <li><a href="<%= request.getContextPath() %>/resources/blog.html">News</a></li>
                                            <li><a href="<%= request.getContextPath() %>/resources/contact.html">Contact</a></li>
                                            <li><a href="<%= request.getContextPath() %>/resources/elements.html">Elements</a></li>
                                ...
                                <div class="login-register-cart-button d-flex align-items-center">
                                    ...
                                    <div class="login-register-btn mr-50">
                                        <a href="<%= request.getContextPath() %>/resources/login.html" id="loginBtn">Login / Register</a>
                                    </div>
            ...
            <div class="row align-items-end">
                <div class="col-12 col-md-5 col-lg-4">
                    <div class="featured-artist-thumb">
                        <img src="<%= request.getContextPath() %>/resources/img/bg-img/fa.jpg" alt="">
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-4">
                    <div class="weeks-top-area mb-100">
                        ...
                        <div class="single-top-item d-flex wow fadeInUp" data-wow-delay="200ms">
                            <div class="thumbnail">
                                <img src="<%= request.getContextPath() %>/resources/img/bg-img/wt3.jpg" alt="">
                            </div>
                            <div class="content-">
                        ...
                        <div class="single-top-item d-flex wow fadeInUp" data-wow-delay="300ms">
                            <div class="thumbnail">
                                <img src="<%= request.getContextPath() %>/resources/img/bg-img/wt5.jpg" alt="">
                            </div>
                            <div class="content-">
                ...
                <div class="col-12 col-lg-4">
                    <div class="new-hits-area mb-100">
                        ...
                        <div class="single-new-item d-flex align-items-center justify-content-between wow fadeInUp" data-wow-delay="150ms">
                            <div class="first-part d-flex align-items-center">
                                <div class="thumbnail">
                                    <img src="<%= request.getContextPath() %>/resources/img/bg-img/wt8.jpg" alt="">
                                </div>
                                <div class="content-">
                                    <h6>Power Play</h6>
                                    <p>In my mind</p>
                        ...
                        <div class="single-new-item d-flex align-items-center justify-content-between wow fadeInUp" data-wow-delay="200ms">
                            <div class="first-part d-flex align-items-center">
                                <div class="thumbnail">
                                    <img src="<%= request.getContextPath() %>/resources/img/bg-img/wt9.jpg" alt="">
                                </div>
                                <div class="content-">
                                    <h6>Cristinne Smith</h6>
                                    <p>My Music</p>
                        ...
                        <div class="single-new-item d-flex align-items-center justify-content-between wow fadeInUp" data-wow-delay="250ms">
                            <div class="first-part d-flex align-items-center">
                                <div class="thumbnail">
                                    <img src="<%= request.getContextPath() %>/resources/img/bg-img/wt10.jpg" alt="">
                                </div>
                                <div class="content-">
                                    <h6>The Music Band</h6>
                                    <p>Underground</p>
                        ...
                        <div class="single-new-item d-flex align-items-center justify-content-between wow fadeInUp" data-wow-delay="300ms">
                            <div class="first-part d-flex align-items-center">
                                <div class="thumbnail">
                                    <img src="<%= request.getContextPath() %>/resources/img/bg-img/wt11.jpg" alt="">
                                </div>
                                <div class="content-">
                                    <h6>Creative Lyrics</h6>
                                    <p>Songs and stuff</p>
                ...
                <div class="col-12 col-lg-4">
                    <div class="popular-artists-area mb-100">
                        ...
                        <div class="single-artists d-flex align-items-center wow fadeInUp" data-wow-delay="150ms">
                            <div class="thumbnail">
                                <img src="<%= request.getContextPath() %>/resources/img/bg-img/pa2.jpg" alt="">
                            </div>
                            <div class="content-">
                                <p>William Parker</p>
                            </div>
                        ...
                        <div class="single-artists d-flex align-items-center wow fadeInUp" data-wow-delay="200ms">
                            <div class="thumbnail">
                                <img src="<%= request.getContextPath() %>/resources/img/bg-img/pa3.jpg" alt="">
                            </div>
                            <div class="content-">
                                <p>Jessica Walsh</p>
                            </div>
                        ...
                        <div class="single-artists d-flex align-items-center wow fadeInUp" data-wow-delay="250ms">
                            <div class="thumbnail">
                                <img src="<%= request.getContextPath() %>/resources/img/bg-img/pa4.jpg" alt="">
                            </div>
                            <div class="content-">
                                <p>Tha Stoves</p>
                            </div>
                        ...
                        <div class="single-artists d-flex align-items-center wow fadeInUp" data-wow-delay="300ms">
                            <div class="thumbnail">
                                <img src="<%= request.getContextPath() %>/resources/img/bg-img/pa5.jpg" alt="">
                            </div>
                            <div class="content-">
                                <p>DJ Ajay</p>
                            </div>
                        ...
                        <div class="single-artists d-flex align-items-center wow fadeInUp" data-wow-delay="350ms">
                            <div class="thumbnail">
                                <img src="<%= request.getContextPath() %>/resources/img/bg-img/pa6.jpg" alt="">
                            </div>
                            <div class="content-">
                                <p>Radio Vibez</p>
                            </div>
                        ...
                        <div class="single-artists d-flex align-items-center wow fadeInUp" data-wow-delay="400ms">
                            <div class="thumbnail">
                                <img src="<%= request.getContextPath() %>/resources/img/bg-img/pa7.jpg" alt="">
                            </div>
                            <div class="content-">
                                <p>Music 4u</p>
                            </div>
