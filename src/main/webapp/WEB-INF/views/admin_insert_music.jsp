  					...
  					<form method="post"  enctype="multipart/form-data" action="<%=request.getContextPath() %>/admin_insert_music_ok.do">
  						<table  id="addTable" border="1">
  							...
  							<tr>
  								...
  								<td> <input type="number" name="minute" value="0" min="0" width="100px" required="required"> 분 
  									 <input type="number" name="second" value="0" max="60" min="0" width="100px" required="required"> 초  
  								</td>
  							</tr>
  							<tr>
